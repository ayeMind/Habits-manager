  ...
  return (
    <PageLayout title="Статистика" defaultTab="statistics">
      <Flex gap={20} align="center">
        <Flex direction="column" align="center">
          <div className={classes["avatar-container"]}>
            ...
            />
            <Skeleton
              className={classes["skeleton-avatar"]}
              circle
              visible={isLoading}
            />
            <input
              type="file"
              title="Выбери новую аватарку"
        ...
        <Flex direction="column" gap="xs">
          ...
          <Tooltip
            label={`Опыт: ${experience}/${maxExperience}`}
            position="top"
          ...
          <Text size="xs">
            Осталось следующего уровня: {maxExperience - experience}
          </Text>
      ...
      <div className={classes["heatmap-container"]}>
        ...
        <Skeleton
          className={
            isLoading ? classes["skeleton-heatmap"] : classes["skeleton-hidden"]
          }
          visible={isLoading}
        />
      </div>
